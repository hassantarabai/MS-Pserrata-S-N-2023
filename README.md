...
### **bamcall_multi.sh**
Utilizing [bamCaller.py](https://github.com/stschiff/msmc-tools) to iterate over a list of bam files and defined contigs to generate a single VCF and a mask file in bed format per sample/contig combination.
